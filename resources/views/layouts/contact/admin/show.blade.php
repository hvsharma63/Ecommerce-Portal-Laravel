...
@section('title')
    <title>Contact Feed List</title>
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Contact Feed List</h4>
...
<div class="row">
	<div class="col-12">
		<div class="card-box">
			<table id="contactTable" class="table table-hover m-0 tickets-list table-actions-bar dt-responsive nowrap" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th>Id</th>
						<th>Name</th>
