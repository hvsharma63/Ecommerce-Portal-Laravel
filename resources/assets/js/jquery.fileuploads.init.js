...
$(document).ready(function(){
    ...
    $("#filer_input1").filer({
		...
		files: [
			...
			// 	size: 145,
			// 	type: "image/jpg",
			// 	file: "../../resources/assets/images/small/img-1.jpg"
			// },
			// {
			// 	name: "2.jpg",
			// 	size: 145,
			// 	type: "image/jpg",
			// 	file: "../../resources/assets/images/small/img-2.jpg"
			// }
		],
        addMore: false,
        clipBoardPaste: true,
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            var file = file.name;
            $.post('../../resources/assets/plugins/jquery.filer/php/remove_file.php', {file: file});
        },
        onEmpty: null,
        options: null,
        captions: {
